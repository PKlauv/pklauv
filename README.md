...
### [Math Phenomena, Visualized](https://pklauv.github.io/Math-Phenomena/)

Interactive browser-based visualizations of chaos theory, topology, and fractals — Lorenz attractor, Mobius strip, Klein bottle, Sierpinski triangle, and Mandelbrot set explorer.

![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?logo=javascript&logoColor=black)
![Plotly.js](https://img.shields.io/badge/Plotly.js-3F4F75?logo=plotly&logoColor=white)
![Canvas API](https://img.shields.io/badge/Canvas%20API-E34F26?logo=html5&logoColor=white)
![Supabase](https://img.shields.io/badge/Supabase-3ECF8E?logo=supabase&logoColor=white)
